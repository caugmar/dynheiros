...
def dezena(numero):
    """
    Converts a number (0-99) into its Portuguese
    word representation for tens.
    """
    if numero < 10:
        ...
        if numero % 10 == 0:
            ...
            return (f"{dezenas[numero - (numero % 10)]}"
                    + f" e {digitos[numero % 10]}")


def centena(numero):
    """
    Converts a number (0-999) into its Portuguese word
    representation for hundreds.
    """
    if numero < 100:
        ...
        if numero % 100 == 0:
            ...
            return (f"{centenas[numero - (numero % 100)]}"
                    + f" e {dezena(numero % 100)}")


def milhar(numero):
    """
    Converts a number (0-999999) into its Portuguese
    word representation for thousands.
    """
    if numero < 1000:
...
def em_reais(numero):
    """
    Converts a numeric value into its Portuguese
    monetary representation (reais and centavos).
    """
